                                ...
                                {!isHistoryMode && <Animated.FlatList
                                    ...
                                    renderItem={({ item }) => {
                                        ...
                                        const getWidth = (key) => {
                                            ...
                                            if (isCardVisible(key) === true) {
                                                if (isInputVisible(currentItemIndex) && showElements) {
                                                    return 150
                                                } else {
                                                    return widthContent - 80
                                                }
                                            } else {
                                                if (isInputVisible(currentItemIndex) && showElements) {
                                                    return 150
                                        ...
                                        return (<FlatView>
                                            <Pressable onPress={() => handleToggleVisibilityGame(item)}>
                                                <Card
                                                    ...
                                                    width={getWidth("card-" + item.couleur + "-" + item.valeur)}
                                                    height={getHeight("card-" + item.couleur + "-" + item.valeur)}
                                                />
                                            </Pressable>
                                        </FlatView>)
                                    }}
